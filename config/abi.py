bex_abi = [
    {
        ...
        "outputs": [
            ...
            {"internalType": "uint256[]", "name": "shareAmounts", "type": "uint256[]"},
    ...
    },
    {
        ...
        "outputs": [
            {"internalType": "address[]", "name": "shares", "type": "address[]"},
            {"internalType": "uint256[]", "name": "shareAmounts", "type": "uint256[]"},
            {"internalType": "address[]", "name": "liqOut", "type": "address[]"},
            {
                "internalType": "uint256[]",
                "name": "liquidityAmounts",
                "type": "uint256[]",
    ...
    },
    {
        "inputs": [
            ...
            {"internalType": "address", "name": "assetOut", "type": "address"},
            {"internalType": "uint256", "name": "amountOut", "type": "uint256"},
            {"internalType": "address", "name": "sharesIn", "type": "address"},
...
honey_abi = [
    {
        "inputs": [
            {"internalType": "contract IERC20", "name": "_honey", "type": "address"}
        ],
        "stateMutability": "nonpayable",
        "type": "constructor",
    },
    {
        ...
        "name": "erc20Module",
        "outputs": [
            {"internalType": "contract IERC20Module", "name": "", "type": "address"}
        ],
        "stateMutability": "view",
        "type": "function",
    },
    ...
    },
    {
        ...
        "name": "honeyModule",
        "outputs": [
            {"internalType": "contract IHoneyModule", "name": "", "type": "address"}
        ],
        "stateMutability": "view",
        "type": "function",
    },
...
ooga_booga_abi = [
    {
        "inputs": [
            {"internalType": "bytes32", "name": "allowlist_", "type": "bytes32"},
            ...
            },
            {
                "components": [
                    ...
                    {"internalType": "uint256", "name": "erc20", "type": "uint256"},
                ],
    ...
    {
        "inputs": [
            {"internalType": "uint256", "name": "claimAmount_", "type": "uint256"}
        ],
        "name": "setClaimAmount",
        "outputs": [],
        "stateMutability": "nonpayable",
    ...
    {
        "inputs": [{"internalType": "bool", "name": "generated_", "type": "bool"}],
        "name": "setGenerated",
        "outputs": [],
        "stateMutability": "nonpayable",
        "type": "function",
